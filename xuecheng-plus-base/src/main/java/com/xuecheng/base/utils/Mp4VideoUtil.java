...
//        Process p = builder.start();
        ...
        //ffmpeg的路径
        String ffmpeg_path = "D:\\Java\\MiddleWare\\ffmpeg\\ffmpeg.exe";//ffmpeg的安装位置
        //源avi视频的路径
        String video_path = "D:\\Java\\MiddleWare\\minIO_download\\1b.avi";
        //转换后mp4文件的名称
        String mp4_name = "1b.mp4";
        //转换后mp4文件的路径
        String mp4_path = "D:\\Java\\MiddleWare\\minIO_download\\1b.mp4";
        //创建工具类对象
